...
internal class InterfaceTranspiler
{
    ...
    {
        static ITypeSymbol GetFeaturedType(ITypeSymbol typeSymbol, SpecialSymbols specialSymbols)
        {
        ...
        var appearTypes = interfaceTypes
            ...
            .SelectMany(x =>
                x.Parameters
                    .Select(y => GetFeaturedType(y.Type, _specialSymbols))
                    .Concat(new[] { GetFeaturedType(x.ReturnType, _specialSymbols) })
            );
